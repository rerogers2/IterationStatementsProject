...
namespace IterationStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // prints out each element of numbers from 1 to 200
            ...
            //start for loop here
            // prints out each element in numbers in reverse order from 200 down to 1
